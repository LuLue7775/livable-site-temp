  ...
  return (
    <div className='relative h-full w-full gap-4'>
      ...
      <div className='absolute bottom-0 left-0 w-full p-6 '>
        <button className='mr-4 w-auto border-b hover:text-red-400' onClick={() => handleClicked('prev')}>
          {' '}
          &lt;- PREV{' '}
        </button>
        <button className='mr-4 w-auto border-b hover:text-red-400' onClick={() => handleClicked('next')}>
          {' '}
          NEXT -&gt;
        </button>
      </div>
