...
const EventLayout = () => {
  ...
  const { events, error, eventsFilters, setEventsFilters, fetchNextPage } = useEvents()
  // console.log(events)
  ...
  return (
    <div className='relative h-full w-full px-8 text-green-900'>
      <div className='relative grid h-auto w-full grid-cols-1 justify-between pb-4 md:h-2/5 md:grid-cols-2 '>
        ...
        >
          <EventsFilterButtons events={events} eventsFilters={eventsFilters} setEventsFilters={setEventsFilters} />
        </div>
        <div
