...
//       render(<VariationSelectFields variations={selectData} />)

//       expect(screen.getByTestId('select-field')).toHaveLength(selectData.length)

//       Object.entries(variations).forEach(([optionKey, options]) => {
//         const selectField = screen.getByTestId(`select-field-${optionKey}`)
//         expect(selectField).toBeInDocument()
