...
const CheckoutForm = () => {
  ...
  return (
      <form className='m-6 max-w-[370px] text-green-900'>
        ...
        <div className='grid gap-2 '>
          ...
          {errors?.payer?.email?.message && (
            <span className='text-sm text-red-500'>{errors?.payer?.email?.message}</span>
          )}
          ...
          {errors?.payer?.phone?.message && (
            <span className='text-sm text-red-500'>{errors?.payer?.phone?.message}</span>
          )}
